        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Edificios_AspNetUsers_AdminId",
                        column: x => x.AdminId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pagos_AspNetUsers_InquilinoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InquilinoId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departamentos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Departamentos_AspNetUsers_InquilinoId",
                        column: x => x.InquilinoId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Departamentos_Edificios_EdificioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departamentos_EdificioId",
                table: "Departamentos",
                column: "EdificioId");

            migrationBuilder.CreateIndex(
                name: "IX_Departamentos_InquilinoId",
                table: "Departamentos",
                column: "InquilinoId");

            migrationBuilder.CreateIndex(
                name: "IX_Edificios_AdminId",
                table: "Edificios",
                column: "AdminId");
